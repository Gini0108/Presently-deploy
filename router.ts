...
// "Protected" routes
router.get("/", authenticationHandler, userController.getCollection.bind(userController));
router.post("/", authenticationHandler, userController.addObject.bind(userController));
router.delete("/:uuid", authenticationHandler, userController.removeObject.bind(userController));
